...
class SimpleBootstrap5Test extends TestCase
{
    /**
    ...
    public function test_pagination_rendered(): void
    {
        ...
        $response->assertSee(__('pagination.previous'), false);  // Previous button
        $response->assertSee(__('pagination.next'), false);  // Next button
