<!-- Add Student Modal -->
<div id="addStudentModal" class="hidden fixed inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center z-50">
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-3xl">
        ...
        <form id="addStudentForm">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <div>
                    <label for="userID" class="block text-sm font-medium text-gray-700">Student Number</label>
