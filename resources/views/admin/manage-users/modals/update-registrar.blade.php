...
<div id="update_modal" class="fixed inset-0 z-50 hidden bg-gray-800 bg-opacity-75 flex items-center justify-center transition-opacity duration-300 ease-in-out">
        ...
        <form id="update_form">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email_address" class="px-4 py-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-indigo-500 focus:outline-none transition duration-200 ease-in-out" required />
                </div>
  ...
  <script>
  function openRegistrarModal(student_id, last_name, first_name, middle_name, contact_number, address, email_address, program) {
  ...
  document.getElementById('update_form').addEventListener('submit', function(e) {
    ...
    const updated_data = {
        ...
        email_address: document.getElementById('email_address').value, // Ensure the email field is included
