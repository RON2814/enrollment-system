<x-app-layout>
  ...
  <div class="header-wrapper flex justify-between items-center flex-wrap bg-white p-4 py-3">
    <div class="header-title">
      <h2 class="pl-3 font-semibold  text-[#206A5D]">Registrar Admin Management</h2>
    </div>
              ...
              <td class="py-4 px-4 text-sm">
                <div class="flex items-center">
                  <button class="text-blue-500 hover:text-blue-700"
                    onclick="openRegistrarModal('123', 'Apayong', 'John', 'Aaron', '123-456-7890', '123 Main St.', 'department@gmail.com', 'Computer Science')">
