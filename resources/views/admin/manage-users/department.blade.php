<x-app-layout>
              ...
              <td class="py-4 px-4 text-sm">
                <div class="flex items-center">
                  <button class="text-blue-500 hover:text-blue-700"
                    onclick="open_Advisers_modal('123', 'Apayong', 'John', 'Aaron', '123-456-7890', '123 Main St.', 'department@gmail.com', 'Computer Science')">
  ...
  <!-- Include modals -->
  @include('modals.manage-users.add-advisers')
  @include('modals.manage-users.update-advisers')
