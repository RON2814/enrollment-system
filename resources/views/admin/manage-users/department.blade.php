<x-app-layout>
    ...
    <div class="header-wrapper flex justify-between items-center flex-wrap bg-white p-4 py-3">
        <div class="header-title">
            <h2 class="pl-3 font-semibold  text-[#206A5D]">Department Admin Management</h2>
        </div>
        ...
        <div class="bg-white mt-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 p-8">
            <div class="flex items-center justify-between mb-5">
                ...
                <div class="flex space-x-4">
                    ...
                    <!-- Add New Button -->
                    <button onclick="openAddAdvisers()"
                ...
                <table class="min-w-full table-fixed border-separate border-spacing-0">
                    ...
                    <tbody class="text-gray-700">
                        <tr class="hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <td class="py-4 px-4 text-sm  max-w-xs">Apayong</td>
                            <td class="py-4 px-4 text-sm  max-w-xs">John</td>
                            <td class="py-4 px-4 text-sm  max-w-xs">Aaron</td>
                            <td class="py-4 px-4 text-sm  max-w-xs">123-456-7890</td>
                            <td class="py-4 px-4 text-sm  max-w-xs">123 Main St.</td>
                            <td class="py-4 px-4 text-sm  max-w-xs">department@gmail.com</td>
                            <td class="py-4 px-4 text-sm  max-w-xs">Computer Science</td>
                            <td class="py-4 px-4 text-sm">
                                <div class="flex items-center">
                                    <button class="text-blue-500 hover:text-blue-700" onclick="open_Advisers_modal('123', 'Apayong', 'John', 'Aaron', '123-456-7890', '123 Main St.', 'department@gmail.com', 'Computer Science')">
  ...
  <!-- Include modals -->
  @include('admin.manage-users.modals.add-advisers')
  @include('admin.manage-users.modals.update-advisers')
