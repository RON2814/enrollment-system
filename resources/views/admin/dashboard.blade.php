            ...
            <div class="card-wrapper">
                <div class="item-card light-red">
                    <div class="card-header">
                        <div class="total">
                            <span class="title">No. of Students</span>
                            <span class="total-value">{{ 'number' }}</span>
                        </div>
                        <i class="fa-regular fa-user icon"></i>
                    </div>
                    <span class="card-detail">Active enrolled students</span>
                </div>

                <div class="item-card light-green">
                    <div class="card-header">
                        <div class="total">
                            <span class="title">No. of Registrar</span>
                            <span class="total-value">{{ 'number' }}</span>
                        </div>
                        <i class="fa-regular fa-user icon dark-green"></i>
                    </div>
                    <span class="card-detail">Active registrar</span>
                </div>

                <div class="item-card light-blue">
                    <div class="card-header">
                        <div class="total">
                            <span class="title">No. of Registration Advisers</span>
                            <span class="total-value">{{ 'number' }}</span>
                        </div>
                        <i class="fa-regular fa-user icon dark-blue"></i>
                    </div>
                    <span class="card-detail">Active department faculty advisers</span>
                </div>
            </div>
        </div>
