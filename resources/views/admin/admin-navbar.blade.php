...
<aside class="sidebar fixed top-0 left-0 bottom-0 w-1/6 h-full p-6 bg-[#0A6847] text-white shadow-lg z-50 transition-all duration-300 ease-in-out">
    <!-- Sidebar Header -->
    ...
    <ul class="menu h-[80%] relative list-none p-0">
        <!-- Dashboard -->
        <li class="menu-item p-4 my-2 rounded-xl transition-all duration-300 ease-in-out @if(request()->routeIs('admin.dashboard')) bg-[#4F9A85] @else hover:bg-[#2c8c6d] @endif">
        ...
        <li class="submenu relative p-4 my-2 rounded-xl transition-all duration-300 ease-in-out">
            ...
            <ul class="submenu-list list-none pl-0 mt-2">
                <li class="submenu-item p-4 my-2 rounded-xl transition-all duration-300 ease-in-out @if(request()->routeIs('admin.manageUsers.student')) bg-[#4F9A85] @else hover:bg-[#2c8c6d] @endif">
                ...
                <li class="submenu-item p-4 my-2 rounded-xl transition-all duration-300 ease-in-out @if(request()->routeIs('admin.manageUsers.department')) bg-[#4F9A85] @else hover:bg-[#2c8c6d] @endif">
                ...
                <li class="submenu-item p-4 my-2 rounded-xl transition-all duration-300 ease-in-out @if(request()->routeIs('admin.manageUsers.registrar')) bg-[#4F9A85] @else hover:bg-[#2c8c6d] @endif">
                ...
                <li class="submenu-item p-4 my-2 rounded-xl transition-all duration-300 ease-in-out @if(request()->routeIs('admin.manageUsers.admin')) bg-[#4F9A85] @else hover:bg-[#2c8c6d] @endif">
