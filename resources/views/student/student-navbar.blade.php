<aside
    class="sidebar fixed top-0 left-0 bottom-0 h-full p-6 bg-[#0A6847] text-white shadow-lg z-50 transition-all duration-300 ease-in-out flex flex-col">
    <!-- Sidebar Header -->
    ...
    <ul class="menu flex-grow relative list-none p-0">
        <!-- Dashboard -->
        <li
