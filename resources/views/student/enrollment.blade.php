<x-app-layout>
  ...
  <div class="main-content p-16 py-2 bg-[#ebe9e9]">
    <div class="overflow-x-auto bg-white p-8 rounded-lg shadow-2xl mt-2">
      ...
      <h2 class="flex justify-between items-center text-2xl font-medium border-b border-gray-300 text-gray-800 mb-5">
      ...
      <div class=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        <div>
          <label class="block text-sm font-medium text-gray-600 mb-1" for="student_number">Student
            Number</label>
          <div id="student_number" class="w-full px-4 py-1 rounded-md bg-gray-100 text-gray-700 text-sm font-semibold">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-600 mb-1" for="classification">Classification</label>
          <div id="classification" class="w-full px-4 py-1 rounded-md bg-gray-100 text-gray-700 text-sm font-semibold">
      ...
      <div class="overflow-x-auto rounded-lg mt-4 ">
        <form action="" method="get">
          ...
          <div class="mt-4">
            <button type="submit" formaction="{{ route('student.enrollment.verify-status') }}"
