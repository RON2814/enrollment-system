...
<div id="enrollModal"
  ...
  <div
    ...
    <div id="page1Content" class="page-content">
      ...
      <h2 class="text-sm font-semibold text-black-600 mb-4 border-b border-gray-200 flex justify-between items-center">
                  ...
                  @foreach ($student->checklist as $item)
                    <tr class="align-middle">
                      ...
                      <td class="px-2 py-2 text-sm border-b">
                        ...
                        <button onclick="dropCourse(this)" class="p-2 bg-red-500 hover:bg-red-700">
