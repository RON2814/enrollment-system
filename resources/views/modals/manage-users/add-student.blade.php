...
<div id="addStudentModal"
    ...
    <div
        ...
        <form id="addStudentForm"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select required id="classification" name="classification"
                            ...
                            <option value="freshman" {{ old('classification') == 'freshman' ? 'selected' : '' }}>
                                Freshman
                            </option>
            ...
            <div id="freshman-fields" class="hidden p-4 border border-gray-200 mt-4 shadow rounded">
                <h3 class="text-base font-semibold mb-3 mb-2 text-dark-green border-b-2 border-gray-400 w-full pb-2">
                    <span class="text-green-800">Additional Information for Freshman</span>
                </h3>
          ...
          <div>
            ...
            <div class="flex justify-between items-center mt-12 border-t border-gray-300 pt-2">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <label for="verifyCheckbox" class="text-gray-500">I confirm that the student's information is
                        accurate
                        and complete.</label>
                </div>
...
<script>
    ...
    function updateButtonText() {
        ...
        enrollSaveButton.textContent = classification === "freshman" ? "Enroll Student" : "Save Student";
    }
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        enrollSaveButton.addEventListener("click", function() {
            const classification = document.getElementById("classification").value;
            if (classification === "freshman" && enrollSaveButton.textContent === "Enroll Student") {
                showSuccessModal();
            }
        });
    });
    ...
    // Toggle visibility of freshman-related fields based on classification selection
    document.getElementById('classification').addEventListener('change', function() {
        const freshmanFields = document.getElementById('freshman-fields');
        const classification = this.value;
        freshmanFields.classList.toggle('hidden', classification !== 'freshman');
    });
    ...
    function toggleBillingFields() {
        const isFreshman = classificationSelect.value === 'freshman';
        billingFields.classList.toggle('hidden', !isFreshman);
        applyFreeTuitionCheckbox.checked = isFreshman;
        togglePaymentFields();
    }
