...
<div id="addStudentModal"
  ...
  <div
    class="modal-container bg-white w-full sm:w-[90%] md:w-[90%] lg:w-[70%] max-w-full rounded-lg shadow-xl p-8 relative overflow-y-auto h-[90vh]">
    ...
    <form id="addStudentForm"
      ...
      <div>
        ...
        <select required id="classification" name="classification"
          ...
          <option value="freshmen" {{ old('classification') == 'freshmen' ? 'selected' : '' }}>Freshmen</option>
