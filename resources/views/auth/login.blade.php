        ...
        <div class="flex justify-between bg-white rounded-3xl shadow-lg overflow-hidden">
            <div class="w-[45%] p-8">
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-4">
                    ...
                    <button 
                        type="submit" 
                        class="bg-green-700 text-white py-3 rounded-md text-base hover:bg-green-800 mt-4">Log In</button>
                </form>
            </div>

            <div class="w-[45%] flex items-center justify-center bg-gray-100">
                <img src="{{ Vite::asset('resources/assets/stingrays.png') }}" alt="University Logo" class="w-full h-full object-cover rounded-lg">
            </div>
        </div>
    </div>
</body>
