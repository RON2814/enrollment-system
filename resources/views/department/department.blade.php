<x-app-layout>
    ...
    <div class="main-content p-4 py-0 bg-[#ebe9e9]">
        ...
        <div class="bg-white p-8 rounded-lg shadow mt-4">
            <h2 class="text-lg font-semibold mb-4 border-b border-gray-200">List of Instructors:</h2>
            <div class="overflow-x-auto rounded-lg mt-4">
                <table class="min-w-full table-auto border-collapse border-spacing-0">
                    <thead class="bg-[#0A6847] text-white text-xs">
                        <tr>
                            <th class="border border-gray-200 py-3 px-4 text-left font-medium">ID</th>
                            <th class="border border-gray-200 py-3 px-4 text-left font-medium">Last Name</th>
                            <th class="border border-gray-200 py-3 px-4 text-left font-medium">First Name</th>
                            <th class="border border-gray-200 py-3 px-4 text-left font-medium">Middle Name</th>
                    ...
                    <tbody class="text-gray-700 border border-gray-200">
                        @foreach ($instructors as $instructor)
                            <tr class="hover:bg-gray-100 transition-colors duration-200">
                                ...
                                <td class="py-4 px-4 text-sm truncate max-w-xs">{{ $instructor->last_name }}</td>
                                <td class="py-4 px-4 text-sm truncate max-w-xs">{{ $instructor->first_name }}</td>
                                <td class="py-4 px-4 text-sm truncate max-w-xs">{{ $instructor->middle_name }}</td>
