    ...
    <div class="main-content p-12 py-2 bg-[#ebe9e9]">
        <div class="p-2 mt-2">
            <div class="flex flex-wrap gap-4 mt-2 justify-between">
                <!-- DCS Students -->
                <div class="p-4 rounded-xl shadow-lg bg-[#074799] opacity-90 text-white flex flex-col items-center flex-1 sm:min-w-[48%] md:min-w-[23%]">
                    <h3 class="mt-2 text-lg font-semibold">Total DCS Students</h3>
                    <p class="mt-2 text-2xl font-bold">{{ $total }}</p> <!-- Dynamic total -->
                </div>

                <!-- CS Students -->
                <div class="p-4 rounded-xl shadow-lg bg-[#fcba03] opacity-90 text-white flex flex-col items-center flex-1 sm:min-w-[48%] md:min-w-[23%]">
                    <h3 class="mt-2 text-lg font-semibold">Advising List</h3>
                    <p class="mt-2 text-2xl font-bold">{{ $advising }}</p> <!-- Dynamic CS students count -->
                </div>

                <div class="p-4 rounded-xl shadow-lg bg-[#C62E2E] opacity-90 text-white flex flex-col items-center flex-1 sm:min-w-[48%] md:min-w-[23%]">
                    <h3 class="mt-2 text-lg font-semibold">Computer Science</h3>
                    <p class="mt-2 text-2xl font-bold">{{ $cs }}</p> <!-- Dynamic CS students count -->
                </div>

                <!-- IT Students -->
                <div class="p-4 rounded-xl shadow-lg bg-[#118B50] opacity-90 text-white flex flex-col items-center flex-1 sm:min-w-[48%] md:min-w-[23%]">
        ...
        <div class="flex gap-6 mt-2">
            ...
            <div class="p-6 rounded-lg shadow mt-3 bg-white w-1/2">
                <div class="mb-6">
                    <h2 class="text-xl font-semibold text-green-700 border-b border-gray-300">Bar Chart of Students</h2>
                </div>
                <div>
            ...
            new Chart(classificationCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [{{ $total }}, {{ $total - $cs }}], // Dynamic total students vs. CS
                        backgroundColor: ['#C62E2E', '#118B50'],
                    }]
                },
                options: {
